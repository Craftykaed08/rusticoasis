...
function LoadJSCode(e, t) {
    if (!Math.fround) {
        ...
        for (
            var n = { LOOKING_FOR_MODULE: 0, SCANNING_MODULE_VARIABLES: 1, SCANNING_MODULE_FUNCTIONS: 2 },
                            ...
                            e: do {
                                ...
                                t: for (;;) {
                                    if (((_ = y >>> 24), (m >>>= _), (w -= _), (_ = (y >>> 16) & 255), 0 === _)) D[s++] = 65535 & y;
                                        ...
                                        (S = 65535 & y),
                                            (_ &= 15),
                                            _ && (_ > w && ((m += E[a++] << w), (w += 8)), (S += m & ((1 << _) - 1)), (m >>>= _), (w -= _)),
                                            15 > w && ((m += E[a++] << w), (w += 8), (m += E[a++] << w), (w += 8)),
                                            (y = g[m & k]);
                                        n: for (;;) {
                        ...
                        function s(e, t) {
                            ...
                            return e && e.state
                                ? ((o = e.state),
                                  ...
                                  t && (8 > t || t > 15) ? F : (null !== o.window && o.wbits !== t && (o.window = null), (o.wrap = n), (o.wbits = t), r(e)))
                                : F;
                        }
                        function d(e, t) {
                            var n, o;
                            ...
                            return (
                                ...
                                o >= a.wsize
                                    ...
                                    : ((i = a.wsize - a.wnext),
                                      ...
                                      (o -= i),
                                      o ? (b.arraySet(a.window, t, n - o, o, 0), (a.wnext = o), (a.whave = a.wsize)) : ((a.wnext += i), a.wnext === a.wsize && (a.wnext = 0), a.whave < a.wsize && (a.whave += i))),
                                0
                            );
                        }
                        function f(e, t) {
                                ...
                                switch (n.mode) {
                                    ...
                                    case Z:
                                        if (
                                            ...
                                            w > d && (w = d),
                                            w &&
                                                (n.head && ((_e = n.head.extra_len - n.length), n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, i, r, w, _e)),
                                    ...
                                    case q:
                                        if (2048 & n.flags) {
                                            if (0 === d) break e;
                                            w = 0;
                                            do (_e = i[r + w++]), n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e));
                                            while (_e && d > w);
                                    ...
                                    case G:
                                        if (4096 & n.flags) {
                                            if (0 === d) break e;
                                            w = 0;
                                            do (_e = i[r + w++]), n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e));
                                            while (_e && d > w);
                                            if ((512 & n.flags && (n.check = v(n.check, i, w, r)), (d -= w), (r += w), _e)) break e;
                            ...
                            return (
                                ...
                                (n.hold = f),
                                (n.bits = h),
                                (n.wsize || (m !== e.avail_out && n.mode < ce && (n.mode < de || t !== M))) && c(e, e.output, e.next_out, m - e.avail_out)
                                    ? ((n.mode = fe), A)
                                    : ((p -= e.avail_in),
                                      (m -= e.avail_out),
                                      (e.total_in += p),
                                      (e.total_out += m),
                                      (n.total += m),
                                      n.wrap && m && (e.adler = n.check = n.flags ? v(n.check, a, m, e.next_out - m) : g(n.check, a, m, e.next_out - m)),
                ...
                9: [
                    function (e, t, n) {
                        ...
                        t.exports = function (e, t, n, p, m, w, b, g) {
                            ...
                            if (
                                (e === s ? ((T = G = b), (x = 19)) : e === d ? ((T = u), (P -= 257), (G = c), (H -= 257), (x = 256)) : ((T = f), (G = h), (x = -1)),
                                (z = 0),
                                (I = 0),
                                (R = F),
                                (S = w),
                            ...
                            for (var j = 0; ; ) {
                                ...
                                do (k -= v), (m[S + (z >> O) + k] = (M << 24) | (C << 16) | E | 0);
                                while (0 !== k);
                                for (v = 1 << (R - 1); z & v; ) v >>= 1;
                ...
                "/lib/inflate.js": [
                    function (e, t, n) {
                        ...
                        (h.prototype.push = function (e, t) {
                            ...
                            do {
                                if ((0 === c.avail_out && ((c.output = new r.Buf8(h)), (c.next_out = 0), (c.avail_out = h)), (n = a.inflate(c, d.Z_NO_FLUSH)), n !== d.Z_STREAM_END && n !== d.Z_OK))
                            ...
                            return (
                                ...
                                o === d.Z_FINISH ? ((n = a.inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === d.Z_OK) : o === d.Z_SYNC_FLUSH ? (this.onEnd(d.Z_OK), (c.avail_out = 0), !0) : !0
                            );
                        }),
...
"function" != typeof window.onerror &&
    (window.onerror = function (e, t, n) {
        return (Module.errorhandler && Module.errorhandler(e, t, n)) ||
            ...
            didShowErrorMessage || -1 != e.indexOf("UnknownError") || -1 != e.indexOf("Program terminated with exit(0)"))
            ? void 0
            : ((didShowErrorMessage = !0),
              -1 != e.indexOf("DISABLE_EXCEPTION_CATCHING")
                  ...
                  ? void alert("Out of memory. If you are the developer of this content, try allocating more memory to your WebGL build in the WebGL player settings.")
                  : -1 != e.indexOf("Invalid array buffer length") || -1 != e.indexOf("Invalid typed array length") || -1 != e.indexOf("out of memory")
                  ? void alert("The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings.")
                  : void alert("An error occured running the Unity content on this page. See your browser's JavaScript console for more info. The error was:\n" + e));
    }),
        ...
        var e = function (e) {
            ...
            function n() {
                ...
                Module.FS_createPath("/", "Il2CppData", !0, !0),
                    ...
                    new t(17514381, 17514402, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"),
                    new t(17514402, 17520199, 0, 0).open("GET", "/preserved_derived_types.xml"),
                    new t(17520199, 19340847, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"),
                    new t(19340847, 20215819, 0, 0).open("GET", "/Resources/unity_default_resources"),
                    new t(20215819, 20243444, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"),
